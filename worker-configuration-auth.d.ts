/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=AuthBindings worker-configuration-auth.d.ts` (hash: 755756bcbd43c65f1812f9e51e2bd61c)
// Runtime types generated with workerd@1.20260903.1 2026-09-07 nodejs_compat
interface __BaseEnv_AuthBindings {
	APP_DB: D1Database;
	AUTH_EMAIL: SendEmail;
	BETTER_AUTH_URL: "https://builder.fonteslabs.com";
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_AuthBindings {}
}
interface AuthBindings extends __BaseEnv_AuthBindings {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}
